...
from monster_config import (bids_dir, deriv_dir, report_dir, task, 
...
for sub_string in sub_list:
    ...
    fig1 = plot_compare_evokeds(these_evokeds, title='Oddball vs. Standard Trials',
                                axes='topo', show=False, show_sensors=True)
    fig2 = plot_compare_evokeds(these_evokeds, title='Oddball vs. Standard - Midline Cluster',
                                combine='mean', show=False, show_sensors=True,
                                picks=['Cz','CPz','Pz','POz'])
    fig3 = plot_compare_evokeds(evokeds[evokeds_key['oddball-standard']], 
                                title='Oddball-Standard Difference Wave - Midline Cluster',
                                combine='mean', show=False, show_sensors=True,
                                picks=['Cz','CPz','Pz','POz'])
    fig4 = plot_compare_evokeds(evokeds[evokeds_key['oddball-standard']], 
    ...
    report.add_slider_to_section(figs, section='ERP', captions=captions,
                                title='ERP: Topo - Oddball vs. Standard', scale=1.5)
    plt.close()
    
    # Top-Bottom
    conds = ['top', 'bottom']
    these_evokeds = [evokeds[evokeds_key[x]] for x in evokeds_key.keys() if x in conds]
    fig1 = plot_compare_evokeds(these_evokeds, title='Top vs. Bottom (Standard) Trials',
                                axes='topo', show=False, show_sensors=True)
    fig2 = plot_compare_evokeds(these_evokeds, title='Top vs. Bottom (Standard) - Posterior Midline Cluster',
                                combine='mean', show=False, show_sensors=True,
                                picks=['Pz','Oz','POz','PO3','PO4'])
    fig3 = plot_compare_evokeds(evokeds[evokeds_key['top-bottom']], 
    ...
    report.add_slider_to_section(figs, section='ERP', captions=captions,
                                title='ERP: Topo - Top vs. Bottom', scale=1.5)
    plt.close()

...
from sof_config import (bids_dir, deriv_dir, task, bv_montage,
                        event_id, preprocess_options)
...
for sub in sub_list:
    ...
    events_bids_file = bids_path / 'eeg' / f'{sub}_task-{task}_events.tsv'
    ...
    n_good_channels = len(mne.pick_types(epochs.info, eeg=True, eog=False,
                          exclude='bads'))

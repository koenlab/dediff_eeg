...
for sub in sub_list:
    ...
    report.add_images_to_section(
        behav_fig_file, captions='Behavior: Performance Summary',
        section='Behavior')
    ...
    json_file = deriv_path / \
        f'{sub}_task-{task}_ref-avg_desc-cleaned_epo.json'
    ...
    fig2 = plot_compare_evokeds(
        these_evokeds, show=False, show_sensors=True,
        picks=['TP7', 'P7', 'PO7'],
        combine='mean',
        title='Scene, Object, and Face Novel Trials - Left Hemisphere')
    fig3 = plot_compare_evokeds(
         these_evokeds,
         title='Scene, Object, and Face Novel Trials - Right Hemisphere',
         show=False, show_sensors=True, picks=['TP8', 'P8', 'PO8'],
         combine='mean')
    captions = [
    ...
    report.add_slider_to_section(figs, section='ERP', captions=captions,
                                 title='ERP: Topo - SOF Novel Trials',
                                 scale=1.5)
    ...
    these_evokeds = \
        [evokeds[evokeds_key[x]] for x in evokeds_key.keys() if x in conds]
    fig1 = plot_compare_evokeds(these_evokeds,
                                title='Difference Waves (vs. object)',
                                axes='topo', show=False, show_sensors=True)
    fig2 = plot_compare_evokeds(
        these_evokeds,
        title='Difference Waves (vs. object) - Left Hemisphere',
        show=False, show_sensors=True, picks=['TP7', 'P7', 'PO7'],
        combine='mean')
    fig3 = plot_compare_evokeds(
        these_evokeds,
        title='Difference Waves (vs. object) - Right Hemisphere',
        show=False, show_sensors=True, picks=['TP8', 'P8', 'PO8'],
        combine='mean')
    captions = [
    ...
    report.add_slider_to_section(
        figs, section='ERP', captions=captions, scale=1.5,
    ...
    these_evokeds = \
        [evokeds[evokeds_key[x]] for x in evokeds_key.keys() if x in conds]
    fig1 = plot_compare_evokeds(these_evokeds,
                                title='Difference Waves (vs. other)',
                                axes='topo', show=False, show_sensors=True)
    fig2 = plot_compare_evokeds(
        these_evokeds,
        title='Difference Waves (vs. other) - Left Hemisphere',
        show=False, show_sensors=True,
        picks=['TP7', 'P7', 'PO7'], combine='mean')
    fig3 = plot_compare_evokeds(
        these_evokeds,
        title='Difference Waves (vs. other) - Right Hemisphere',
        show=False, show_sensors=True,
    ...
    fig1 = plot_compare_evokeds(these_evokeds, title='Scene Difference Waves',
                                axes='topo', show=False, show_sensors=True)
    fig2 = plot_compare_evokeds(
        these_evokeds, title='Scene Difference Waves - Left Hemisphere',
        show=False, show_sensors=True,
        picks=['TP7', 'P7', 'PO7'], combine='mean')
    fig3 = plot_compare_evokeds(
        these_evokeds, title='Scene Difference Waves - Right Hemisphere',
        show=False, show_sensors=True,
        picks=['TP8', 'P8', 'PO8'], combine='mean')
    captions = [
    ...
    report.add_slider_to_section(
        figs, section='ERP', captions=captions, scale=1.5,
        title='ERP: Topo - Scene Difference Waves')
    ...
    fig1 = plot_compare_evokeds(these_evokeds, title='Face Difference Waves',
                                axes='topo', show=False, show_sensors=True)
    fig2 = plot_compare_evokeds(
        these_evokeds, title='Face Difference Waves - Left Hemisphere',
        show=False, show_sensors=True,
        picks=['TP7', 'P7', 'PO7'], combine='mean')
    fig3 = plot_compare_evokeds(
        these_evokeds, title='Face Difference Waves - Right Hemisphere',
        show=False, show_sensors=True,
        picks=['TP8', 'P8', 'PO8'], combine='mean')
    captions = [
    ...
    report.add_slider_to_section(
        figs, section='ERP', captions=captions, scale=1.5,
        title='ERP: Topo - Face Difference Waves')

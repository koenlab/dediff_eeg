"""
Script: study_03_preprocess_eeg.py
...
from study_config import (bids_dir, deriv_dir, task, preprocess_options, 
                        bv_montage)
...
for sub in sub_list:
    ...
    events_bids_file = bids_path / 'eeg' / \
        f'{sub}_task-{task}_events.tsv'
    ...
    json_file = deriv_path / \
        f'{sub}_task-{task}_ref-avg_desc-removedICs_epo.json'
